...
fun QuestionScreen(context: Context, categoryId: Int) {
    ...
    Log.d("LOGTAG", "categoryId: $categoryId")
    ...
    Column(modifier = Modifier
        ...
        AnswerCard(scope, context, 1, selectedGreen, selectedRed, onSelectedGreenChange = {selectedGreen = it},
            onSelectedRedChange = {selectedRed = it}, question, onQuestionChange = {question = it}, categoryId)
        Spacer(modifier = Modifier.height(20.dp))
        AnswerCard(scope, context,2, selectedGreen, selectedRed, onSelectedGreenChange = {selectedGreen = it},
            onSelectedRedChange = {selectedRed = it}, question, onQuestionChange = {question = it}, categoryId)

        if (!question.hasTwoAnswers()) {
            Spacer(modifier = Modifier.height(20.dp))
            AnswerCard(scope, context,3, selectedGreen, selectedRed, onSelectedGreenChange = {selectedGreen = it},
                onSelectedRedChange = {selectedRed = it}, question, onQuestionChange = {question = it}, categoryId)
            Spacer(modifier = Modifier.height(20.dp))
            AnswerCard(scope, context,4, selectedGreen, selectedRed, onSelectedGreenChange = {selectedGreen = it},
                onSelectedRedChange = {selectedRed = it}, question, onQuestionChange = {question = it}, categoryId)
        }
    }
}
